...
<?php
   ...
   $sql = "SELECT * FROM ConsultaPsicologo where id= :id";
...
<div class="container">
  ...
  <label for="">Nome do Aluno</label>                          
        <input type="text" placeholder="Digite seu nome" name="aluno" name="aluno" id="" value="<?php echo $user_name ?>" >
        
        <div class="ulti"> <input type="submit"  name="update" value="Marcar">
    <div class="button"><a href="calendario-aluno-psicologo.php" >Voltar</a></div>
        </div>
  </form>
