<?php
include_once 'armazem-de-dados.php';
?>
...
<div class="layout">
    ...
    <div class="container">
        ...
        <div class="links">
            <div class="botao1">
                  <a class="linktitulo" href="../funcionario/cadastro-funcionario.php">Funcionário</a>
            </div>

            <div class="botao1">
                  <a class="linktitulo" href="cadastro-aluno.php">Aluno</a>
            </div>
        ...
        <form action="armazem-de-dados.php" method="post">
            ...
            <div class="organizacao">
                ...
                <div class="organizacao1">
                  ...
                  <input type="email" class="input1" id="email" name="emailInstitucional" required>
                ...
                <div class="organizacao2">
                  ...
                  <input type="text" maxlength="4" class="input2" id="turma" name="turma" required>

                  <label for="cpf">CPF:</label>
                  <input type="text" maxlength="14" minlength="14" class="input2" id="cpf" name="cpf" required>
            ...
            <div class="link">
                <label>Já possui cadastro? <a href="login-aluno.php" id="fazerlogin">Fazer login</a></label>
            </div>
        </form>
    ...
    <div class="decoracao">
            <img class="decoracaoImagem" src="../aluno/imagens/imagem-dentista-removebg-preview.png" alt="">
            <img class="decoracaoImagem" src="../aluno/imagens/imagem-psicologo.png" alt="">
    </div>
</div>
