...
<?php
   ...
   ##sql para selecionar apens um Funcionario
  ...
  #transforma o retorno em array
   ...
   $linkCurriculo = $array_retorno ['linkCurriculo'];
   $crocrp = $array_retorno ['crocrp'];
...
<div class="layout">
    ...
    <div class="container">
        ...
        <form action="../funcionario/armazem-de-dados-funcionario.php" method="post">
                ...
                <div class="organizacao1">
                  ...
                  <label for="email">CRO ou CRP:</label>
                  <input type="text" class="nomeeemail" id="email" name="crocrp" required 
                  value="<?php echo htmlspecialchars($user_tipo); ?>">
                  </div>
                ...
                <div class="dadosnome">
                  ...
                  <img class="lnr-eye" id="imgolho" onclick="mostrarsenha()" src="../funcionario/eye.svg" alt="">
                  </div>
                ...
                <div class="nomedados2">
                  ...
                  <div class="turma"><label for="crocrp">Currículo:<label></div>
                ...
                <div class="dadosnome">
                     ...
                     <input type="url" maxlength="4" class="input2" name="linkCurriculo" required
                     value="<?php echo htmlspecialchars($linkCurriculo); ?>">
                ...
                <div class="botaolayout">
                   <input type="submit" name="edicao" value="Confirmar edições"> 
                </div>
