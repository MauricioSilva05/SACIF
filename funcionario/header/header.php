...
<header>
  ...
  <a href="../../index-funcionario.php"><button name="" class="lateralic" id="icon2"  type="submit"><img src="../header/imagens/home.png" alt=""><p>Início</p></button></a>
  


  <button  name="" class="lateralic" id="icon2"  type="submit"> <img src="../header/imagens/chat.png" alt=""><p>Chat</p></button>

  <form method="POST" action="../editar-perfil-funcionario.php">
