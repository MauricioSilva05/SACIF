...
if (isset($_GET['cadastrar'])) {
    ...
    if (!empty($_GET['horario']) && !empty($_GET['dt'] )) {
        ...
        $sqlVerificaHorario = "SELECT COUNT(*) as total FROM ConsultaPsicologo WHERE horario = :horario AND dt = :dt ";
        ...
        if ($totalHorarios > 0) {
            ...
            $sqlInserir = "INSERT INTO ConsultaPsicologo (horario, dt, funcionario) VALUES (:horario, :dt, :funcionario)";
...
<option value="08:00-as-08:30">08:00 às 08:30</option>
    ...
    <!-- Add more time options as needed -->
        ...
        <label for="dt">CRP</label>
        <input type="text" id="crocrp" name="crocrp" value="<?php echo $user_tipo ;?>" readonly>
