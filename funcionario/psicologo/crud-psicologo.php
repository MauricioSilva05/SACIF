...
if(isset($_GET['update'])){
    ...
    $aluno = $_GET["aluno"];
      ...
      ##codigo sql
    $sql = "UPDATE  ConsultaPsicologo SET horario= :horario, dt= :dt, tipo= :tipo, aluno= :aluno WHERE id= :id ";
...
if (isset($_GET['excluir'])) {
    ...
    try {
        ...
        echo "<script> alert('Consulta cancelada com sucesso!') 
             window.location.href = 'historico-psicologo.php';
             </script> ";
             sleep(1);
...
if (isset($_GET['remarcar'])) {
    ...
    try {
        ...
        header('Location: calendario-psicologo.php');
