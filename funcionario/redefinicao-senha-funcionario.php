  ...
  <div class="main">
    ...
    <form action="armazem-de-dados-funcionario.php" method="post">
      ...
      <div class="form-group">
        ...
        <input type="crocrp" placeholder="Digite o CRO ou CRP cadastrado anteriormente" id="crocrp" name="crocrp" required>
      </div>
      ...
      <div class="inputSenha">
        ...
        <img class="lnr-eye"  id="imgolho2" onclick="mostrarsenha2()" src="../funcionario/imagens/eye.svg" alt="">
      </div>
      </div>

      <div class="botaolayout">
      <input type="submit" value="Confirmar" name="redefinicaoSenha">
      <a href="../funcionario/login-funcionario.php" id="fazerlogin">Voltar</a>
      </div>
