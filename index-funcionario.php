...
// Define the URLs for redirection based on user_tipo
if ($user_tipo === "CRO") {
  $redirectURL = "funcionario/dentista/calendario-dentista.php";
} elseif ($user_tipo === "CRP") {
  $redirectURL = "funcionario/psicologo/calendario-psicologo.php";
} 
if ($user_tipo === "CRO") {
  $redirectURL1 = "funcionario/dentista/historico-dentista.php";
} elseif ($user_tipo === "CRP") {
  $redirectURL1 = "funcionario/psicologo/historico-psicologo.php";
} 
...
?>
  ...
  <form method="POST" action="../projeto-interdisciplinar-PSW/funcionario/editar-perfil-funcionario.php">
...
<div class="opcao2">
            ...
            <button class="consulta"> 
                <img src="../projeto-interdisciplinar-PSW/imagens-index/agenda.png"  alt="agenda.png" class="icon"><a href="<?php echo $redirectURL; ?>" class="um">Consulta</a>
           
            <button class="historico"> 
                <img src="../projeto-interdisciplinar-PSW/imagens-index/dias-do-calendario.png"  alt="dias-do-calendario.png" class="icon"><a href="<?php echo $redirectURL1; ?>">Histórico</a>  
